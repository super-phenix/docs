...
1. [Manual OS installation](../installing-the-os/manual-os-installation.md): bootstrap Talos on the AZ that will host management.
2. [Installing management plane](index.md): install the operator and configure the management stack.
3. [Installing an AZ](../installing-an-az/index.md): define `Cluster` resources for your AZs.
