...
6. Continue with [Installing management plane](../installing-management/index.md) on this cluster (or register it as a remote cluster from your management plane).
...
- Install the operator: [Installing management plane](../installing-management/index.md).
