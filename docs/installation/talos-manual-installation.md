...
Part of the [installation guide](full-installations.md). For the automated alternative, see [Automated OS installation](operator-physical-installation.md).
...
6. Continue with [Installation management](installation-management.md) on this cluster (or register it as a remote cluster from your management plane).
...
- Install the operator: [Installation management](installation-management.md).
- Define your AZ: [Configure a cluster](configure-cluster.md).
